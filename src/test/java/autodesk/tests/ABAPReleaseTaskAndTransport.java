...
public class ABAPReleaseTaskAndTransport extends AutodeskBaseUtility{
	...
	public static void releaseTRTask() throws Exception {
		...
		driver.findElement(By.id("100")).sendKeys(prop.getProperty("ABAPTRR"));	
		r.keyPress(KeyEvent.VK_TAB);
		r.keyRelease(KeyEvent.VK_TAB);
		driver.findElement(By.id("100")).sendKeys(prop.getProperty("ABAPTRT"));	
		r.keyPress(KeyEvent.VK_TAB);
		r.keyRelease(KeyEvent.VK_TAB);
	...
	public static void releaseTransport() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@title='Choose the value of criterion Requested Start'])[1]")).sendKeys(prop.getProperty("ABAPDate"));
		Thread.sleep(2000);
		driver.findElement(By.xpath("//b[text()='Search']")).click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[text()='"+prop.getProperty("ABAPCharmID")+"']")));
		driver.findElement(By.xpath("//a[text()='"+prop.getProperty("ABAPCharmID")+"']")).click();
